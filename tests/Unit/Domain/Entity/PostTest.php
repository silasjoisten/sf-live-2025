...
final class PostTest extends UnitTestCase
{
     ...
     * @test
     */
    public function imageFilenameKeyMustExist(): void
    {
        $values = self::response(content: [
            'image' => [
                'alt' => self::faker()->sentence(),
        ...
        unset($values['content']['image']['filename']);
    ...
    public function imageAltKeyMustExist(): void
    {
        $values = self::response(content: [
            'image' => [
                'filename' => self::faker()->url(),
            ],
        ]);
        unset($values['content']['image']['alt']);
